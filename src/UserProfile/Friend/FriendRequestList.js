...
function FriendRequest({ username }) {
  ...
  return (
    (listOfFriendRequests.length ===0) ? (
      <div className="FriendReqList"><h2>Friend Requests</h2><h3>No Friend Requests</h3></div>) : (<div className="FriendReqList"><h2>Friend Requests</h2><div>{listOfFriendRequests}</div></div>)
  );
}
